...
## 概要
这是一个完整的第三人称用户故事，描述外部漏洞情报如何通过系统的持续分析，在特定的内部资产上下文中被升级为高风险，并最终触发紧急预警邮件被发送给系统负责人。
...
1. **数据拉取**：OpenCTITool 向 OpenCTI 查询 CVE-2026-4141 的完整信息，包括：
...
**通知工具（NotificationTool）** 根据上述分析，自动生成并发送以下预警邮件：

---

**收件人**：安全负责人 (security.chief@company.com); 支付业务负责人 (payment.owner@company.com)  
